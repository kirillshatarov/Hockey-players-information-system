...
<body>
        ...
        <div class="container-fluid navbar navbar-inverse">
            ...
            <div class="collapse navbar-collapse" id="navbarNavAltMarkup">
                <div class="navbar-nav">
                    ...
                    <a href="adminu.html">Администратору</a>
    ...
    <div class="logo">
        <div><a href="\Project\hc\list_club_admin.php?league=khl"><img src="img/logo_khl_300.png" alt="КХЛ"></a></div>
        <div><a href="\Project\hc\list_club_admin.php?league=nhl"><img src="img/logo_nhl_300.png" alt="НХЛ"></a></div>
    </div>
</body>
